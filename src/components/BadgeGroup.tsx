...
const baseClasses: Record<Theme, { root?: string; addon?: string; icon?: string }> = {
    ...
    modern: {
        root: "rounded-[10px] bg-[var(--bg-surface)] text-[var(--text-secondary)] shadow-[var(--shadow-xs)] ring-1 ring-inset ring-[var(--border-default)] hover:bg-[var(--bg-subtle)]",
        addon: "flex items-center rounded-md bg-[var(--bg-surface)] shadow-[var(--shadow-xs)] ring-1 ring-inset ring-[var(--border-default)]",
...
const colorClasses: Record<Theme, Record<Color, { root?: string; addon?: string; icon?: string; dot?: string }>> = sortCx({
    light: {
        brand: {
            ...
            addon: "bg-[var(--bg-surface)] text-current ring-utility-brand-200",
        ...
        gray: {
            ...
            addon: "bg-[var(--bg-surface)] text-current ring-utility-neutral-200",
            icon: "text-utility-neutral-500",
        },
        error: {
            root: "bg-utility-red-50 text-utility-red-700 ring-utility-red-200 hover:bg-utility-red-100",
            addon: "bg-[var(--bg-surface)] text-current ring-utility-red-200",
        ...
        warning: {
            ...
            addon: "bg-[var(--bg-surface)] text-current ring-utility-yellow-200",
        ...
        success: {
            ...
            addon: "bg-[var(--bg-surface)] text-current ring-utility-green-200",
