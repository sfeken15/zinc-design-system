...
const styles = sortCx({
    light: {
        ...
        colors: {
            brand: "bg-[var(--bg-brand-muted)] text-featured-icon-light-fg-brand",
            gray: "bg-[var(--bg-muted)] text-featured-icon-light-fg-gray",
    ...
    gradient: {
        base: "rounded-full text-[var(--text-inverse)] before:absolute before:inset-0 before:size-full before:rounded-full before:border before:mask-b-from-0% after:absolute after:block after:rounded-full",
        sizes: {
        ...
        colors: {
            brand: "before:border-utility-brand-200 before:bg-utility-brand-50 after:bg-[var(--bg-brand-default)]",
            gray: "before:border-utility-neutral-200 before:bg-utility-neutral-50 after:bg-[var(--bg-subtle)]-solid",
    ...
    dark: {
        base: "text-[var(--text-inverse)] shadow-[var(--shadow-xs)]-skeuomorphic before:absolute before:inset-px before:border before:border-white/12 before:mask-b-from-0%",
        sizes: {
        ...
        colors: {
            brand: "bg-[var(--bg-brand-default)] before:border-utility-brand-200/12",
            gray: "bg-[var(--bg-subtle)]-solid before:border-utility-neutral-200/12",
    ...
    modern: {
        base: "bg-[var(--bg-surface)] shadow-[var(--shadow-xs)]-skeuomorphic ring-1 ring-[var(--border-default)] ring-inset",
        sizes: {
    ...
    "modern-neue": {
        base: [
            ...
            // Shadow
            "before:shadow-[0px_1px_2px_0px_rgba(0,0,0,0.1),0px_3px_3px_0px_rgba(0,0,0,0.09),1px_8px_5px_0px_rgba(0,0,0,0.05),2px_21px_6px_0px_rgba(0,0,0,0),0px_0px_0px_1px_rgba(0,0,0,0.08),1px_13px_5px_0px_rgba(0,0,0,0.01),0px_-2px_2px_0px_rgba(0,0,0,0.13)_inset] before:ring-1 before:ring-[var(--border-subtle)]",
        ].join(" "),
        sizes: {
        ...
        colors: {
            brand: "",
            gray: "text-[var(--icon-subtle)] ring-[var(--border-default)]",
            error: "",
            warning: "",
            success: "",
        },
    ...
    outline: {
        ...
        colors: {
            brand: "text-[var(--icon-brand)] before:border-fg-brand-primary/30 after:border-fg-brand-primary/10",
            gray: "text-[var(--icon-subtle)] before:border-fg-tertiary/30 after:border-fg-tertiary/10",
            error: "text-[var(--color-error-text)] before:border-fg-error-primary/30 after:border-fg-error-primary/10",
            warning: "text-[var(--color-warning-text)] before:border-fg-warning-primary/30 after:border-fg-warning-primary/10",
            success: "text-[var(--color-success-text)] before:border-fg-success-primary/30 after:border-fg-success-primary/10",
        },
    },
});
