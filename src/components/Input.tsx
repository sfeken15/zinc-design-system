    ...
    return (
        ...
        >
            ...
            <AriaInput
                ...
                className={cx(
                    "m-0 w-full bg-transparent text-[var(--text-primary)] ring-0 outline-hidden placeholder:text-[var(--text-[var(--text-tertiary)])] autofill:rounded-lg autofill:text-[var(--text-primary)] disabled:cursor-not-allowed",
